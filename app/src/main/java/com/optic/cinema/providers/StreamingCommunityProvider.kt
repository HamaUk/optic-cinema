...
import com.optic.cinema.extractors.VixcloudExtractor
...
import com.optic.cinema.utils.InertiaUtils
import com.optic.cinema.utils.NetworkClient
import com.optic.cinema.utils.TmdbUtils
...
class StreamingCommunityProvider(private val _language: String? = null) : Provider {
    ...
    override suspend fun getServers(id: String, videoType: Video.Type): List<Video.Server> {
        Log.i("Optic CinemaES", "[PROV] -> StreamingCommunity: getServers for $id")
        ...
        Log.i("Optic CinemaES", "[PROV] -> Found Vixcloud src: $src")
        return listOf(Video.Server(id = id, name = "Vixcloud", src = src))
    }

    override suspend fun getVideo(server: Video.Server): Video {
        Log.i("Optic CinemaES", "[SERVER] -> StreamingCommunity: Using ${server.name} (Src: ${server.src})")
