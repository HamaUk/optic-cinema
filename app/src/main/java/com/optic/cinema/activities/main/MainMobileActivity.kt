...
import com.optic.cinema.databinding.ActivityMainMobileBinding
...
class MainMobileActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            if (UserPreferences.currentProvider == null) {
                UserPreferences.currentProvider = TmdbProvider("ckb")
            }
    ...
    private fun handleIntent(intent: Intent): Boolean {
        ...
        if (data.scheme == "opticcinema" && data.host == "resolve") {
