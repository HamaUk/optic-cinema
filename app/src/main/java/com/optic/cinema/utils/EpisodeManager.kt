...
import com.optic.cinema.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.optic.cinema.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
