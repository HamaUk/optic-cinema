...
import com.optic.cinema.databinding.ItemSettingMobileBinding
import com.optic.cinema.databinding.ViewPlayerSettingsMobileBinding
import com.optic.cinema.utils.dp
import com.optic.cinema.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.optic.cinema.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.optic.cinema.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.optic.cinema.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.optic.cinema.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
