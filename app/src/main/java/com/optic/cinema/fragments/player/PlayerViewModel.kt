...
import com.optic.cinema.utils.CustomTabHelper
...
class PlayerViewModel(
    ...
    private fun getServers(videoType: Video.Type, id: String) = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            Log.i("Optic CinemaES", "[SERVERS LIST] -> Provider: ${UserPreferences.currentProvider!!.name}")
            Log.i("Optic CinemaES", "[SERVERS LIST] -> Found ${servers.size} servers: ${servers.joinToString { it.name }}")
