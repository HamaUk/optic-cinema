package com.optic.cinema.fragments.player.settings
...
import com.optic.cinema.utils.OpenSubtitles
import com.optic.cinema.utils.mediaServers
import com.optic.cinema.utils.SubDL
import com.optic.cinema.utils.UserPreferences
import com.optic.cinema.utils.dp
import com.optic.cinema.utils.findClosest
import com.optic.cinema.utils.getAlpha
import com.optic.cinema.utils.getRgb
import com.optic.cinema.utils.mediaServerId
import com.optic.cinema.utils.mediaServers
import com.optic.cinema.utils.setAlpha
import com.optic.cinema.utils.setRgb
import com.optic.cinema.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.optic.cinema.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.optic.cinema.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.optic.cinema.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.optic.cinema.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
