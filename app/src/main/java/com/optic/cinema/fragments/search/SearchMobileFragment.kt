package com.optic.cinema.fragments.search
...
import com.optic.cinema.databinding.FragmentSearchMobileBinding
...
import com.optic.cinema.utils.LoggingUtils
import com.optic.cinema.utils.UserPreferences // <-- IMPORT AÑADIDO
import com.optic.cinema.utils.VoiceRecognitionHelper
import com.optic.cinema.utils.dp
import com.optic.cinema.utils.hideKeyboard
                ...
                when (state) {
                    ...
                    is State.FailedSearching -> {
                        ...
                        if (code == 409 && !hasAutoCleared409) {
                            ...
                            android.widget.Toast.makeText(requireContext(), getString(com.optic.cinema.R.string.clear_cache_done_409), android.widget.Toast.LENGTH_SHORT).show()
                        ...
                        if (appAdapter.isLoading) {
                            ...
                            binding.isLoading.apply {
                                ...
                                btnIsLoadingClearCache.setOnClickListener {
                                    CacheUtils.clearAppCache(requireContext())
                                    android.widget.Toast.makeText(requireContext(), getString(com.optic.cinema.R.string.clear_cache_done), android.widget.Toast.LENGTH_SHORT).show()
                                    doRetry()
                                }
